...
<a href="#"><i class="material-icons">library_books</i><span>calender</span></a></li>
 ...
 if(!doctors.isEmpty()){
     ...
     <input type="checkbox" id="select" > </span></td>
                        <td><%= d.getId() %></td>
                        <td><%= d.getNom() %></td>
                        <td><%= d.getPrenom() %></td>
                        ...
                        <td>
                         <form action="EditDoc" method="post" >
                                ...
                                <button type="submit" class="edit" data-bs-target="#editDoctorModal" data-bs-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></button>
                         </form>
                            
                             <form action="DeleteDoc" method="post" >
                                <input hidden value="<%= d.getId() %>" name="id" />
                                <button type="submit" class="delte" data-bs-toggle="modal" data-bs-target="#deleteDoctorModal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></button>
                               </form>
 ...
 %>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
         <form action="edit.doctor" method="post" enctype="multipart/form-data">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
         <form action="delete.doctor" method="post" enctype="multipart/form-data">
